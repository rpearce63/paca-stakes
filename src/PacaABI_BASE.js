export const ABI = [
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_vestingIndex", type: "uint256" },
    ],
    name: "claimBonus",
    outputs: [],
    stateMutability: "nonpayable",
    ...
    inputs: [
      {
        ...
        internalType: "struct PacaFinanceWithBoostAndScheduleUSDC.StakeInput[]",
        name: "stakesInput",
        type: "tuple[]",
      },
    ],
    ...
    outputs: [
      ...
      { internalType: "uint256[]", name: "stakeIds", type: "uint256[]" },
      {
        components: [
          ...
          { internalType: "uint256", name: "lastClaimed", type: "uint256" },
          { internalType: "uint256", name: "dailyRewardRate", type: "uint256" },
          { internalType: "uint256", name: "origUnlockTime", type: "uint256" },
        ],
        internalType: "struct PacaFinanceWithBoostAndScheduleUSDC.SellStake[]",
        name: "sellStakeData",
        type: "tuple[]",
      },
    ...
    outputs: [
      {
        ...
        internalType:
          "struct PacaFinanceWithBoostAndScheduleUSDC.WithdrawStake[]",
        name: "",
        type: "tuple[]",
      },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "depositedTokens", type: "uint256" },
    ],
    name: "getBoost",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    ...
    outputs: [
      {
        ...
        internalType: "struct PacaFinanceWithBoostAndScheduleUSDC.Stake[]",
        name: "",
        type: "tuple[]",
      },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "_user", type: "address" },
      { internalType: "bool", name: "isRestake", type: "bool" },
    ],
  ...
  },
  {
    ...
    outputs: [{ internalType: "uint256", name: "totalUsd", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256[]", name: "usdValues", type: "uint256[]" },
    ...
    outputs: [
      {
        ...
        internalType: "struct PacaFinanceWithBoostAndScheduleUSDC.Vesting[]",
        name: "",
        type: "tuple[]",
      },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "_stakeIndex", type: "uint256" },
      { internalType: "uint256", name: "_restakePercentage", type: "uint256" },
    ],
    name: "restake",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint256", name: "timeOffset", type: "uint256" },
  ...
  {
    inputs: [{ internalType: "uint256", name: "_newTax", type: "uint256" }],
    name: "updateSellTax",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_newKickback", type: "uint256" },
    ],
    name: "updatesellKickBack",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
